...
# Version: 1.0
# Available from: https://github.com/Tekton-MAS/repositorion-nimi.git
...
# ASETTELU:
# top=0.85 -> Jättää enemmän tilaa otsikon alle (oli 0.9)
# bottom=0.35 -> Jättää tilaa säätimille
...
# Nostetaan säätimiä hieman, jotta alas jää tilaa
...
# --- RESET-NAPPI ---
# Nostettu hieman ylemmäs (y=0.06), jotta credit-teksti mahtuu alle
...
# --- CREDIT-TEKSTI ---
# Aivan alareunassa (y=0.01). Reset-nappi on nyt ylempänä (0.06), joten eivät osu.
